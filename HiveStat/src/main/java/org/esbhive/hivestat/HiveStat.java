...
//			}
            ...
            sortedNodeList = insertionSort(nodeList, CreateProxyServiceAdminStub(nodeList[nodeList.length - 1].getUsername(), nodeList[nodeList.length - 1].getPassword(), nodeList[nodeList.length - 1].getIpAndPort()));
        } else {
