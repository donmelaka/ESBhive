...
/**
 * SetServiceOperationMessagePolicy.java
 *
 ...
 */
            ...
            /**
            *  SetServiceOperationMessagePolicy bean class
            */
        
        public  class SetServiceOperationMessagePolicy
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setServiceOperationMessagePolicy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setServiceOperationMessagePolicy",
    ...
    public static class Factory{
        ...
        */
        public static SetServiceOperationMessagePolicy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetServiceOperationMessagePolicy object =
                new SetServiceOperationMessagePolicy();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setServiceOperationMessagePolicy".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetServiceOperationMessagePolicy)org.esbhive.hp.mgt.carbon.util.java.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
