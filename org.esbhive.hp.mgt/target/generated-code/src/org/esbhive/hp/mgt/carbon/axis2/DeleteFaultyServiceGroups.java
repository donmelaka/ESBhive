...
/**
 * DeleteFaultyServiceGroups.java
 *
 ...
 */
            ...
            /**
            *  DeleteFaultyServiceGroups bean class
            */
        
        public  class DeleteFaultyServiceGroups
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":deleteFaultyServiceGroups",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "deleteFaultyServiceGroups",
                ...
                if (localFileNamesTracker){
                             if (localFileNames!=null) {
                                   ...
                                   for (int i = 0;i < localFileNames.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://org.apache.axis2/xsd", "fileNames", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static DeleteFaultyServiceGroups parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteFaultyServiceGroups object =
                new DeleteFaultyServiceGroups();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deleteFaultyServiceGroups".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteFaultyServiceGroups)org.esbhive.hp.mgt.carbon.util.java.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","fileNames").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://org.apache.axis2/xsd","fileNames").equals(reader.getName())){
