...
/**
 * SetServiceOperationPolicy.java
 *
 ...
 */
            ...
            /**
            *  SetServiceOperationPolicy bean class
            */
        
        public  class SetServiceOperationPolicy
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setServiceOperationPolicy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setServiceOperationPolicy",
    ...
    public static class Factory{
        ...
        */
        public static SetServiceOperationPolicy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetServiceOperationPolicy object =
                new SetServiceOperationPolicy();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setServiceOperationPolicy".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetServiceOperationPolicy)org.esbhive.hp.mgt.carbon.util.java.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
