...
/**
 * SetBindingOperationPolicy.java
 *
 ...
 */
            ...
            /**
            *  SetBindingOperationPolicy bean class
            */
        
        public  class SetBindingOperationPolicy
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setBindingOperationPolicy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setBindingOperationPolicy",
    ...
    public static class Factory{
        ...
        */
        public static SetBindingOperationPolicy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetBindingOperationPolicy object =
                new SetBindingOperationPolicy();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setBindingOperationPolicy".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetBindingOperationPolicy)org.esbhive.hp.mgt.carbon.util.java.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
