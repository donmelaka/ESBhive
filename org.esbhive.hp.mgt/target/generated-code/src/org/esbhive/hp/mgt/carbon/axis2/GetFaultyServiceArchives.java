 ...
 */
            ...
            /**
            *  GetFaultyServiceArchives bean class
            */
        
        public  class GetFaultyServiceArchives
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getFaultyServiceArchives",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getFaultyServiceArchives",
    ...
    public static class Factory{
        ...
        */
        public static GetFaultyServiceArchives parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetFaultyServiceArchives object =
                new GetFaultyServiceArchives();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getFaultyServiceArchives".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetFaultyServiceArchives)org.esbhive.hp.mgt.carbon.util.java.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
