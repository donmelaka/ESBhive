 ...
 */
            ...
            /**
            *  SetModulePolicy bean class
            */
        
        public  class SetModulePolicy
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setModulePolicy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setModulePolicy",
    ...
    public static class Factory{
        ...
        */
        public static SetModulePolicy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetModulePolicy object =
                new SetModulePolicy();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setModulePolicy".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetModulePolicy)org.esbhive.hp.mgt.carbon.util.java.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
