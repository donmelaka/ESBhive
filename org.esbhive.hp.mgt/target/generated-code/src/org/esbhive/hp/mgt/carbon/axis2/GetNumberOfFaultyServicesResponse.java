...
/**
 * GetNumberOfFaultyServicesResponse.java
 *
 ...
 */
            ...
            /**
            *  GetNumberOfFaultyServicesResponse bean class
            */
        
        public  class GetNumberOfFaultyServicesResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getNumberOfFaultyServicesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getNumberOfFaultyServicesResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetNumberOfFaultyServicesResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetNumberOfFaultyServicesResponse object =
                new GetNumberOfFaultyServicesResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getNumberOfFaultyServicesResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetNumberOfFaultyServicesResponse)org.esbhive.hp.mgt.carbon.util.java.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
