...
/**
 * GetNumberOfActiveServicesResponse.java
 *
 ...
 */
            ...
            /**
            *  GetNumberOfActiveServicesResponse bean class
            */
        
        public  class GetNumberOfActiveServicesResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getNumberOfActiveServicesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getNumberOfActiveServicesResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetNumberOfActiveServicesResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetNumberOfActiveServicesResponse object =
                new GetNumberOfActiveServicesResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getNumberOfActiveServicesResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetNumberOfActiveServicesResponse)org.esbhive.hp.mgt.carbon.util.java.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
