...
/**
 * GetBindingOperationMessagePolicy.java
 *
 ...
 */
            ...
            /**
            *  GetBindingOperationMessagePolicy bean class
            */
        
        public  class GetBindingOperationMessagePolicy
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getBindingOperationMessagePolicy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getBindingOperationMessagePolicy",
    ...
    public static class Factory{
        ...
        */
        public static GetBindingOperationMessagePolicy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetBindingOperationMessagePolicy object =
                new GetBindingOperationMessagePolicy();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getBindingOperationMessagePolicy".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetBindingOperationMessagePolicy)org.esbhive.hp.mgt.carbon.util.java.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
