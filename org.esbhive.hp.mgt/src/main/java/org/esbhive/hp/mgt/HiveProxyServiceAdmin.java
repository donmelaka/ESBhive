...
public class HiveProxyServiceAdmin {
    ...
    public String deleteProxyService(String proxyName) throws ProxyAdminException {
        ...
        return proxyAdmin.deleteProxyService(proxyName);
    }
    ...
    public String[] getAvailableSequences() throws ProxyAdminException {
      ...
      *
      */
       return  proxyAdmin.getAvailableSequences();
    }
    ...
    public String[] getAvailableEndpoints() throws ProxyAdminException {
        org.wso2.carbon.proxyadmin.service.ProxyServiceAdmin proxyAdmin = new org.wso2.carbon.proxyadmin.service.ProxyServiceAdmin();
       // proxyAdmin.getAvailableEndpoints();
        /*  try {
        ...
        String serviceEPR = "https://" + "localhost:9444" + "/services/" + "AuthenticationAdmin";
        ...
        boolean isLogged = stub.login("admin", "admin", "localhost:9444");

        String cookie = (String) stub._getServiceClient().getServiceContext().getProperty(
        HTTPConstants.COOKIE_STRING);

        String serviceEPR4 = "https://" + "localhost:9444" + "/services/" + "ProxyServiceAdmin";
         ...
         *
         */
        return proxyAdmin.getAvailableEndpoints();
     /*try {
    ...
    public MetaData getMetaData() throws ProxyAdminException {
      //   org.wso2.carbon.proxyadmin.service.ProxyServiceAdmin proxyAdmin = new  org.wso2.carbon.proxyadmin.service.ProxyServiceAdmin();
       ...
       // metaData=proxyAdmin.getMetaData();
      //  return metaData;
    ...
    public ProxyData getProxy(String proxyName) throws ProxyAdminException {
        ...
        try {
            ...
            boolean isLogged = stub.login("admin", "admin", "localhost:9444");// this was 9443
    ...
    public String addProxy(ProxyData pd) throws ProxyAdminException {
        ...
        try {
            ...
            ESBNode tempEsbNode = nodeList[1];//getRandomNumber(0,nodeList.length)
    ...
    private void createDummyProxies(ProxyData pd) {
        ...
        URL url = null;
        try {
            String targetURL = "http://localhost:8280/services/StockQuoteProxy";
