...
<%
    ...
    try {
        ...
        // defined endpoints
        definedEPs = (metaData.getEndpointsAvailable()) ? metaData.getEndpoints() : null;
        // available transports
        tps = (metaData.getTransportsAvailable()) ? metaData.getTransports() : null;
        // defined sequences
        definedSeqs = (metaData.getSequencesAvailable()) ? metaData.getSequences() : null;
    ...
    String startOnLoadBox = "<input type=\"checkbox\" checked name=\"startOnLoad\"/>";
    // if the given proxy data mentions not to start on load then remove the check
    if (pd != null && !pd.getStartOnLoad()) {
        startOnLoadBox = startOnLoadBox.replaceFirst("checked ", "");
    }
    ...
    String anonEpAddEdit = bundle.getString("anon.add");
    String anonEpXML;
    ...
    anonInAddEdit = anonOutAddEdit = anonFaultAddEdit = bundle.getString("anon.add");
...
<script type="text/javascript">
    ...
    function validatePage(num) {
        ...
        if (num == 0) {
            ...
            if (getElement('inSeqOpAnon').checked ) {
                if (getElement('inAnonAddEdit').innerHTML == '<fmt:message key="anon.add"/>') {
            ...
            if (getElement('epOpAnon').checked) {
                if (getElement('epAnonAddEdit').innerHTML == '<fmt:message key="anon.add"/>') {
            ...
            if (getElement('outSeqOpAnon').checked && getElement('outAnonAddEdit').innerHTML == '<fmt:message key="anon.add"/>' ) {
            ...
            if (getElement('faultSeqOpAnon').checked && getElement('faultAnonAddEdit').innerHTML == '<fmt:message key="anon.add"/>' ) {
    ...
    function populateServiceParams() {
        ...
        if (customHeadersCount > 0) {
            str += customHeaders[0]['name'] + ',' + customHeaders[0]['value'];
            for (i = 1; i < customHeadersCount; i++) {
                str += '::' + customHeaders[i]['name'] + ',' + customHeaders[i]['value'];
            }
        }
    ...
    function anonEpClear() {
        anonEpAction = "<fmt:message key="anon.add"/>";
...
<tr id="step0">
    <td><h2><fmt:message key="proxy.service.page0"/></h2></td>
</tr>
<tr id="step1">
    <td><h2><fmt:message key="proxy.service.page1"/></h2></td>
</tr>
<tr id="step2">
    <td><h2><fmt:message key="proxy.service.page2"/></h2></td>
</tr>
<tr>
    <td><table class="normal"><tbody><tr>
    <td><fmt:message key="proxy.service.name"/>
        <span class="required">*</span>
    </td>
    <td align="left">
        <% if (!nameDisabled) { %>
        <input id="psName" name="psName" type="text" value="<%=name%>" onkeypress="return validateText(event);"/></td>
        <% } else { %>
        <input id="proxyName" name="proxyName" type="text" value="<%=name%>" disabled="disabled"/>
        <input id="psName" name="psName" type="hidden" value="<%=name%>"></td>
        <% } %>
    </tr></tbody></table></td>
</tr>
<tr>
...
<br/><br/>
					...
					<td style="border: solid 1px #ccc !important;">
						...
						</td><td class="nopadding" style="padding-top: 10px !important">
                                                    <a href="#" class="registry-picker-icon-link"                                                       
...
<table class="normal-nopadding">
				<tr>
                                <td width="20%">
<fmt:message key="load.service.on.startup"/></td>
                                <td ><%=startOnLoadBox%>
                                </td>
                            </tr>
</table>
...
<table class="normal-nopadding">
				<tr>
                                <td width="20%"><fmt:message key="pinned.servers.separated.by.comma.or.space"/></td>
...
<tr>
                                ...
                                <td >
                                    <div id="nameValueAdd">
                                        <table><tbody><tr><td>
                                            <fmt:message key="name"/>: <input type="text" id="headerName"/>
                                        </td>
                                            <td class="nopadding">
                        ...
                        <div id="inSeqDesign">
                            <table id="inSeqOptionTable" class="normal">
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;" class="nopadding"><fmt:message key="select.inseq.none"/></td>
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;" class="nopadding"><fmt:message key="anonymous"/></td>
                                    <td style="vertical-align:middle;" class="nopadding">
                                        <% if (anonInAddEdit.equalsIgnoreCase(bundle.getString("anon.add"))) {%>
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;" class="nopadding"><fmt:message key="pick.from.registry"/></td>
                                    <td class="nopadding">
                                        <table id="inRegistry">
                                            <tr>
                                                <td class="nopadding">
                                                ...
                                                <td class="nopadding">
                                                    <a href="#" class="registry-picker-icon-link"
                                                       ...
                                                       onclick="showRegistryBrowser('proxy.in.registry','/_system/config');"><fmt:message
                                                            key="conf.registry"/></a>
                                                </td>
                                                <td class="nopadding">
                                                    <a href="#" class="registry-picker-icon-link"
                                                       style="padding-left:40px"
                                                       onclick="showRegistryBrowser('proxy.in.registry','/_system/governance');"><fmt:message
                                                            key="gov.registry"/></a>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;" class="nopadding"><fmt:message key="import"/></td>
                                    <td style="vertical-align:middle;" class="nopadding">
                        ...
                        <div id="endpointDesign">
                            <table id="epOptionTable" class="normal">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;" class="nopadding"><fmt:message key="anonymous"/></td>
                                    <td style="vertical-align:middle;" class="nopadding">
                                    <% if (anonEpAddEdit.equalsIgnoreCase(bundle.getString("anon.add"))) { %>
                                        ...
                                        <table id="eprRegistry">
                                            <tr>
                                                ...
                                                <td class="nopadding">
                                                    <a href="#" class="registry-picker-icon-link"
                                                       style="padding-left:40px"
                                                       onclick="showRegistryBrowser('proxy.epr.registry','/_system/config')"><fmt:message
                                                            key="conf.registry"/></a>
                                                </td>
                                                <td class="nopadding">
                                                    <a href="#" class="registry-picker-icon-link"
                                                       style="padding-left:40px"
                                                       onclick="showRegistryBrowser('proxy.epr.registry','/_system/governance')"><fmt:message
                                                            key="gov.registry"/></a>
                                                </td>
                                            </tr>
                                        </table>
                        ...
                        <div id="outSeqDesign">
                            <table id="outSeqOptionTable" class="normal">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;" class="nopadding"><fmt:message key="anonymous"/></td>
                                    <td style="vertical-align:middle;" class="nopadding">
                                        <% if (anonOutAddEdit.equalsIgnoreCase(bundle.getString("anon.add"))) { %>
                                        ...
                                        <table id="outRegistry" class="normal-nopadding">
                                            <tr>
                                                ...
                                                <td class="nopadding">
                                                    <a href="#" class="registry-picker-icon-link"
                                                       style="padding-left:40px"
                                                       onclick="showRegistryBrowser('proxy.out.registry','/_system/config')"><fmt:message
                                                            key="conf.registry"/></a>
                                                </td>
                                                <td class="nopadding">
                                                    <a href="#" class="registry-picker-icon-link"
                                                       style="padding-left:40px"
                                                       onclick="showRegistryBrowser('proxy.out.registry','/_system/governance')"><fmt:message
                                                            key="gov.registry"/></a>
                                                </td>
                                            </tr>
                                        </table>
                        ...
                        <div id="faultSeqDesign">
                            <table id="faultSeqOptionTable" class="normal">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;" class="nopadding"><fmt:message key="anonymous"/></td>
                                    <td style="vertical-align:middle;" class="nopadding">
                                        <% if (anonFaultAddEdit.equalsIgnoreCase(bundle.getString("anon.add"))) { %>
                                        ...
                                        <table id="faultRegistry">
                                            <tr>
                                                ...
                                                <td class="nopadding">
                                                    <a href="#" class="registry-picker-icon-link"
                                                       style="padding-left:40px"
                                                       onclick="showRegistryBrowser('proxy.fault.registry','/_system/config')"><fmt:message
                                                            key="conf.registry"/></a>
                                                </td>
                                                <td class="nopadding">
                                                    <a href="#" class="registry-picker-icon-link"
                                                       style="padding-left:40px"
                                                       onclick="showRegistryBrowser('proxy.fault.registry','/_system/governance')"><fmt:message
                                                            key="gov.registry"/></a>
                                                </td>
                                            </tr>
                                        </table>
