...
import org.wso2.carbon.proxyadmin.ui.types.carbon.Entry;
...
import org.wso2.carbon.proxyadmin.ui.HiveProxyServiceAdminStub;
...
public class ProxyServiceAdminClient {
    ...
    public HiveProxyServiceAdminStub stub;
    ...
    public ProxyServiceAdminClient(ConfigurationContext configCtx, String backendServerURL,
        ...
        String serviceURL = backendServerURL + "HiveProxyServiceAdmin";
        stub = new HiveProxyServiceAdminStub(configCtx, serviceURL);
