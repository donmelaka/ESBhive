 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected org.wso2.carbon.proxyadmin.xsd.ProxyData[] localProxyDataList ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localProxyDataListTracker = false ;
                           ...
                           */
                           public  org.wso2.carbon.proxyadmin.xsd.ProxyData[] getProxyDataList(){
                              ...
                              /**
                               * validate the array for ProxyDataList
                               */
                              protected void validateProxyDataList(org.wso2.carbon.proxyadmin.xsd.ProxyData[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param ProxyDataList
                              */
                              public void setProxyDataList(org.wso2.carbon.proxyadmin.xsd.ProxyData[] param){
                              
                                   validateProxyDataList(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localProxyDataListTracker = true;
                                          } else {
                                             localProxyDataListTracker = true;
                                                 
                                          }
                                      
                                      this.localProxyDataList=param;
                              }
                             ...
                             * @param param org.wso2.carbon.proxyadmin.xsd.ProxyData
                             */
                             public void addProxyDataList(org.wso2.carbon.proxyadmin.xsd.ProxyData param){
                                   if (localProxyDataList == null){
                                   localProxyDataList = new org.wso2.carbon.proxyadmin.xsd.ProxyData[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localProxyDataList);
                               list.add(param);
                               this.localProxyDataList =
                             (org.wso2.carbon.proxyadmin.xsd.ProxyData[])list.toArray(
                            new org.wso2.carbon.proxyadmin.xsd.ProxyData[list.size()]);
                                       ...
                                       if (localProxyDataList!=null){
                                            for (int i = 0;i < localProxyDataList.length;i++){
                                                if (localProxyDataList[i] != null){
                                                 localProxyDataList[i].serialize(new javax.xml.namespace.QName("http://mgt.proxyconf.esbhive.org/xsd","proxyDataList"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://mgt.proxyconf.esbhive.org/xsd", "proxyDataList", xmlWriter);
                             ...
                             if (localProxyDataList!=null) {
                                 for (int i = 0;i < localProxyDataList.length;i++){
                                    ...
                                    if (localProxyDataList[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://mgt.proxyconf.esbhive.org/xsd",
                                                                          "proxyDataList"));
                                         elementList.add(localProxyDataList[i]);
                                    } else {
                                        ...
                                        elementList.add(new javax.xml.namespace.QName("http://mgt.proxyconf.esbhive.org/xsd",
                                                                          "proxyDataList"));
                                        elementList.add(localProxyDataList);
    ...
    public static class Factory{
        ...
        */
        public static ProxyDataList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ProxyDataList object =
                new ProxyDataList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ProxyDataList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ProxyDataList)org.esbhive.proxyconf.mgt.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mgt.proxyconf.esbhive.org/xsd","proxyDataList").equals(reader.getName())){
