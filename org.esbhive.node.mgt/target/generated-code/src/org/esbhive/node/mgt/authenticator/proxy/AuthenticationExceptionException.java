...
public class AuthenticationExceptionException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1304822242310L;
    
    private org.esbhive.node.mgt.authenticator.proxy.AuthenticationExceptionE faultMessage;
    ...
    public void setFaultMessage(org.esbhive.node.mgt.authenticator.proxy.AuthenticationExceptionE msg){
       faultMessage = msg;
    }
    
    public org.esbhive.node.mgt.authenticator.proxy.AuthenticationExceptionE getFaultMessage(){
       return faultMessage;
    }
}
