...
<tr>
    <td width="30%">
	    <fmt:message key="operation"/>
            ...
            <td width="30%"><nobr>
                <input type="radio" name="messageType" value="In" checked> <fmt:message
                    key="in.message"/>
                <input type="radio" name="messageType" value="Out"> <fmt:message key="out.message"/></nobr>
            </td>
            <td><input class="button" type="submit"
                                             value="<fmt:message key="edit.policy"/>"/>
...
<form action="policy_editor_proxy.jsp" name="frmPolicyMetaData">
        ...
        <tr>
            <td width="30%">
                    ...
                    <td width="30%"><nobr><input type="radio" name="messageType"
                                                               value="In" checked> <fmt:message
                            key="in.message"/>
                        <input type="radio" name="messageType" value="Out"> <fmt:message
                            key="out.message"/></nobr>
