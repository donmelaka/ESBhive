...
<%@ page import="org.wso2.carbon.service.mgt.ui.types.carbon.ServiceGroupMetaDataWrapper" %>
...
<%
    ...
    try {
        ...
        serviceGroupInfo = client.getAllServices(serviceTypeFilter,
                serviceGroupSearchString,
                Integer.parseInt(pageNumber));
        numberOfPages = serviceGroupInfo.getNumberOfPages();
        mdata = serviceGroupInfo.getMetadataList();
                    ...
                    <u>
                        <a href="faulty_services.jsp">
                            <font color="red"><%= faultyServiceGroups%>
                                <fmt:message key="faulty.service.groups"/></font>
                        </a>
                    </u>
                    <%
                            }
...
<%
    List<String> userPermission =
            (ArrayList<String>) request.getSession().getAttribute(ServerConstants.USER_PERMISSIONS);
...
<carbon:itemGroupSelector selectAllInPageFunction="selectAllInThisPage(true)"
                          ...
                          deleteFunction="deleteServiceGroups()"
                          deleteButtonId="delete1"
                          resourceBundle="org.wso2.carbon.service.mgt.ui.i18n.Resources"
