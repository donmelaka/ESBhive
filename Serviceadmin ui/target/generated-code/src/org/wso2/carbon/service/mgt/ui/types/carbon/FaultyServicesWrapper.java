 ...
 */
            ...
            /**
            *  FaultyServicesWrapper bean class
            */
        
        public  class FaultyServicesWrapper
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected org.wso2.carbon.service.mgt.ui.types.carbon.FaultyService[] localFaultyServices ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return org.wso2.carbon.service.mgt.ui.types.carbon.FaultyService[]
                           */
                           public  org.wso2.carbon.service.mgt.ui.types.carbon.FaultyService[] getFaultyServices(){
                               ...
                               */
                              protected void validateFaultyServices(org.wso2.carbon.service.mgt.ui.types.carbon.FaultyService[] param){
                              ...
                              */
                              public void setFaultyServices(org.wso2.carbon.service.mgt.ui.types.carbon.FaultyService[] param){
                             ...
                             * @param param org.wso2.carbon.service.mgt.ui.types.carbon.FaultyService
                             */
                             public void addFaultyServices(org.wso2.carbon.service.mgt.ui.types.carbon.FaultyService param){
                                   if (localFaultyServices == null){
                                   localFaultyServices = new org.wso2.carbon.service.mgt.ui.types.carbon.FaultyService[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localFaultyServices);
                             ...
                             (org.wso2.carbon.service.mgt.ui.types.carbon.FaultyService[])list.toArray(
                            new org.wso2.carbon.service.mgt.ui.types.carbon.FaultyService[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FaultyServicesWrapper",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                       ...
                                       if (localFaultyServices!=null){
                                            for (int i = 0;i < localFaultyServices.length;i++){
                                                if (localFaultyServices[i] != null){
                                                 localFaultyServices[i].serialize(new javax.xml.namespace.QName("http://mgt.service.carbon.wso2.org/xsd","faultyServices"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://mgt.service.carbon.wso2.org/xsd", "faultyServices", xmlWriter);
                                 ...
                                 for (int i = 0;i < localFaultyServices.length;i++){
                                    ...
                                    if (localFaultyServices[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://mgt.service.carbon.wso2.org/xsd",
                                                                          "faultyServices"));
                                         elementList.add(localFaultyServices[i]);
                                    } else {
                                        ...
                                        elementList.add(new javax.xml.namespace.QName("http://mgt.service.carbon.wso2.org/xsd",
                                                                          "faultyServices"));
                                        elementList.add(localFaultyServices);
    ...
    public static class Factory{
        ...
        */
        public static FaultyServicesWrapper parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FaultyServicesWrapper object =
                new FaultyServicesWrapper();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FaultyServicesWrapper".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FaultyServicesWrapper)org.wso2.carbon.service.mgt.ui.types.carbon.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mgt.service.carbon.wso2.org/xsd","faultyServices").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list1.add(org.wso2.carbon.service.mgt.ui.types.carbon.FaultyService.Factory.parse(reader));
                                                                }
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://mgt.service.carbon.wso2.org/xsd","faultyServices").equals(reader.getName())){
                                                        ...
                                                        object.setFaultyServices((org.wso2.carbon.service.mgt.ui.types.carbon.FaultyService[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                org.wso2.carbon.service.mgt.ui.types.carbon.FaultyService.class,
                                                                list1));
